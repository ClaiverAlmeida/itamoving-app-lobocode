      ...
      <DialogContent className="w-[95vw] sm:w-[92vw] lg:w-[84vw] max-w-4xl lg:max-w-5xl max-h-[85vh] sm:max-h-[90vh] overflow-y-auto rounded-lg">
        ...
        <form onSubmit={onSubmit} className="space-y-4 lg:space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
            ...
            <div className="space-y-2">
              <Label htmlFor="edit-weightLimit">Limite de Peso (kg) *</Label>
              <Input id="edit-weightLimit" type="number" step="0.01" min="0.01" placeholder="Ex: 28000" value={formData.weightLimit} onChange={(e) => setFormData({ ...formData, weightLimit: e.target.value })} required />
            </div>
