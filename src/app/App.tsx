...
function MainApp() {
  ...
  const getMenuItems = () => {
    ...
    const allMenuItems = [
      ...
      {
        id: "containers" as View,
        label: "Containers",
        icon: Container,
        module: "containers" as const,
      },
      {
      ...
      {
        id: "atendimentos" as View,
        label: "Atendimentos",
        icon: Headset,
        module: "atendimentos" as const,
      },
      {
        id: "precos" as View,
        label: "Preços",
      ...
      {
        id: "motorista" as View,
        label: "Motorista",
        icon: Truck,
        module: "motorista" as const,
      },
    ];
  ...
  const renderView = () => {
    ...
    switch (activeView) {
      ...
      case "estoque":
        return hasPermission("estoque", "read") ? (
          <EstoqueView />
        ) : (
          <AcessoNegado />
        );
      case "agendamentos":
        return hasPermission("agendamentos", "read") ? (
          <AgendamentosView />
        ) : (
          <AcessoNegado />
        );
      case "containers":
        return hasPermission("containers", "read") ? (
          <ContainersView />
        ) : (
          <AcessoNegado />
        );
      ...
      case "atendimentos":
        return hasPermission("atendimentos", "read") ? (
          <AtendimentosView />
        ) : (
          <AcessoNegado />
        );
      ...
      case "rh":
        return hasPermission("rh", "read") ? <RHView /> : <AcessoNegado />;
      case "motorista":
        return hasPermission("motorista", "read") ? (
          <MotoristaApp />
        ) : (
          <AcessoNegado />
        );
            ...
            <div className="flex items-center gap-2 lg:gap-4">
              ...
              {user?.avatar ? (
                <img
                  src={user.avatar}
                  alt={user.nome}
                  className="w-8 h-8 lg:w-10 lg:h-10 rounded-full shadow-lg"
                />
              ) : (
